...
public class LoginView implements IView {
	...
	/**
	 * The constructor is used to get the content from the MainActivity in order
	 * to use getResources() and getPackageName()
	 * 
	 * @author Hai Tang
	 */
	...
	public View getView(String viewName) {
		...
		// Hai's comments: this piece of codes works in MainActivity, but not
		// here.
		...
		// usernameEditTextObject = (EditText)
		// activity.findViewById(R.id.edit_username);
		//
