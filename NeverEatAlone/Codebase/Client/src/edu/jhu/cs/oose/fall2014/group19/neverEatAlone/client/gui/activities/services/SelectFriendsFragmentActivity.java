...
public class SelectFriendsFragmentActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_select_friends_fragment);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			// below).
			if (position == 0)
				return new SelectFriendsActivity("getAll", postData);

			return new SelectFriendsActivity("getNearby", postData);
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View rootView = inflater.inflate(R.layout.fragment_select_friends,
					container, false);
			return rootView;
		}
	}
