...
public class DBQueryExecutionManager implements IDBQueryExecutionManager {
	...
	@Inject IDBInstanceManager iDBInstanceMangerObject;
	...
	public List<Map<String,String>> executeQuery(String query,
		...
		GraphDatabaseService graphDatabaseInstance = 
				iDBInstanceMangerObject.getGraphDatabaseInstance(); 


		ExecutionEngine executionEngine = new ExecutionEngine(graphDatabaseInstance,
				StringLogger.SYSTEM);				
	 ...
	 * @return
	 */		
	private static List<Map<String,String>> GetResultMapList(ExecutionResult result){


		// ************** LOGGING ************************
		System.out.println("Inside DBRequestHnadlerHelper: getting result maplist");
		// ************** LOGGING ************************
